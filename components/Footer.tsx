              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="p-2 rounded-xl bg-primary/10 hover:bg-primary/20 text-primary hover:text-secondary transition-all duration-200 shadow-soft focus:outline-none focus:ring-2 focus:ring-primary/30 focus:ring-offset-2 focus:ring-offset-base dark:bg-slate-700 dark:hover:bg-primary-800 dark:text-slate-100 dark:hover:text-secondary-dark dark:focus:ring-primary-dark/30 dark:focus:ring-offset-base-dark"
                    aria-label={social.name}
                  >
                    <Icon className="h-5 w-5 dark:text-slate-100" />
                  </a>
                )
              })}
            </div>
